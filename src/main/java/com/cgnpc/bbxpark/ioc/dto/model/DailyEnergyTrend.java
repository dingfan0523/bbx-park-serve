 ...
 * @author dingfan
 * @version 1.0
 * @date 2026/2/28 15:09
 */
@Data
@ApiModel(value = "日均节能趋势")
public class DailyEnergyTrend {
...
//    @JsonFormat(pattern = "MM-dd", timezone = "GMT+8", shape = JsonFormat.Shape.STRING)
    ...
    private Date date;
    @ApiModelProperty(value = "每日节能时长列表(小时)")
    private Double energySavingHour;
    @ApiModelProperty(value = "每日节约能耗列表(KWH)")
