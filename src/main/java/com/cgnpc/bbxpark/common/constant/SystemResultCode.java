...
public enum SystemResultCode implements IResultCode {
    ...
    MENU_ENCODING_ALREADY_EXISTS(30052, "菜单编码已存在,请确认"),
    ...
    CONFIG_SYS_CONFIG_CAN_NOT_DELETE(40017, "系统配置无法删除"),
    ASSERT_ERROR(40017, "断言异常"),
    DICT_CATEGORY_HAS_ITEM_CAN_NOT_DELETE(40018, "字典拥有子项，无法删除"),
    MENU_HAS_CHILDREN_CAN_NOT_DELETE(40019, "菜单拥有子菜单，无法删除"),
    GROUP_HAS_CHILDREN_CAN_NOT_DELETE(40020, "分组下有成员，无法删除"),
    GROUP_HAS_ADMIN(40021, "分组已有管理员"),
    MEMBER_IS_NOT_ADMIN_CAN_NOT_CANCEL(40022, "非管理员无法取消"),
    TENANT_HAS_MEMBER_CAN_NOT_CANCEL(40023, "租户有成员无法删除"),
    GROUP_SIZE_REACH(40024, "分组已满员，无法添加成员"),

    /* 数据错误：50001-599999 */
    RESULT_DATA_NONE(50001, "数据未找到"),
    DATA_IS_WRONG(50002, "数据有误"),
    DATA_ALREADY_EXISTED(50003, "数据已存在"),
    DATA_ALREADY_ROLE_CODE_EXISTED(50003, "角色编码已存在"),
    DATA_ALREADY_ROLE_NAME_EXISTED(50003, "角色名称已存在"),
    ...
    /* 服务治理错误码 80001-89999 */
    GATEWAY_ROUTE_IS_PUBLISH(80001, "当前网关路由已发布");
