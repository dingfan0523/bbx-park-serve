...
public class InspectionPlanModel implements Serializable {
     ...
     * serialVersionUID.
     */
    private static final long serialVersionUID = -4806374067975058086L;
    ...
    private List<InspectionPointModel> pointModels;
    @ApiModelProperty(value = "巡检材料集合.")
    private List<InspectionMaterialModel> materialModels;
}
