...
@Data
public class TaskPlanParam implements Serializable {
    /**
     * serialVersionUID.
     */
    private static final long serialVersionUID = -3324586817619102389L;
    ...
    @ApiModelProperty(value = "任务计划明细信息.")
    private List<TaskItemParam> taskItemParams;
}
