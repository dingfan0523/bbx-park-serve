 ...
 */
@Data
public class MaintainPlanModel implements Serializable {
    ...
    @ApiModelProperty(value = "维保任务集合.")
    private List<MaintainPlanTaskGroupModel> taskGroupModels;

    @ApiModelProperty(value = "维保材料集合.")
    private List<MaintainMaterialModel> materialModels;
