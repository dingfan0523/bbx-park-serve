...
@Data
@TableName("bbx_task_plan")
public class TaskPlan extends BaseExEntity implements Serializable {
    /**
     * serialVersionUID.
     */
    private static final long serialVersionUID = -4103282491236523535L;
	/**
	*计划名称.
	**/
