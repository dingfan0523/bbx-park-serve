 ...
 */
@Data
@TableName("bbx_patrol_plan")
public class PatrolPlan extends BaseExEntity implements Serializable {
    /**
     * serialVersionUID.
     */
    private static final long serialVersionUID = -4114626269895523477L;
