...
@Slf4j
public class DwdVehicleRepairListener extends AnalysisEventListener<DwdVehicleRepairParam> {
    ...
    @Getter
    private List<DwdVehicleRepairParam> addList = new ArrayList<>();
     ...
     */
    @Override
    public void invoke(DwdVehicleRepairParam param, AnalysisContext analysisContext) {
        // 获取当前解析行的索引（0开始）
        ...
        try {
            ...
            log.info("车辆维修信息第{}行解析失败：{}", currentRowIndex + 1 , e.getMessage());
        }
        addList.add(param);
    }
