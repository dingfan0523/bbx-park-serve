...
public class InvitationParam implements Serializable {
    ...
    @ApiModelProperty(value = "邀约区域集合.")
    private List<InvitationSpaceRelationParam> invitationSpaceList;

    @ApiModelProperty(value = "邀约访客集合.")
    private List<InvitationVisitorParam> invitationVisitorList;
}
